...
const UploadWidget = ({
    ...
    useEffect(() => {
        ...
        // initializeWidget() will return true if the widget is already initialized,
        const initializeWidget = () => {
            if (!window.cloudinary || widgetRef.current) return false;

            // widgetRef.current will be set to the widget instance
        ...
        // if not, we'll try to initialize it every 500ms until it succeeds'
